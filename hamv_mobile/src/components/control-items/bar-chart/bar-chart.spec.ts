...
describe('Component: Bar Chart', () => {
  ...
  it('should create', () => {
    ...
    expect(component instanceof BarChart).toBeTruthy();
...
describe('Component: Bar Chart - lifecycle', () => {
  ...
  beforeEach(() => {
    ...
    cp.registerComponent('bar-chart', BarChart);
  });

  afterEach(() => cp.unregisterComponent('bar-chart'));
