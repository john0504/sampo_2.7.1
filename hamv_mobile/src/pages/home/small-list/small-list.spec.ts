...
describe('Page - medium list', () => {
  let component: SmallListPage;
  let fixture: ComponentFixture<SmallListPage>;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      ...
      imports: [
        IonicModule.forRoot(SmallListPage),
    ...
    fixture = TestBed.createComponent(SmallListPage);
  ...
  it('should create', () => {
    ...
    expect(component instanceof SmallListPage).toBeTruthy();
  });
});
