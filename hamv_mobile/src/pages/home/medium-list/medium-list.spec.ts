...
describe('Page - medium list', () => {
  let component: MediumListPage;
  let fixture: ComponentFixture<MediumListPage>;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      ...
      imports: [
        IonicModule.forRoot(MediumListPage),
    ...
    fixture = TestBed.createComponent(MediumListPage);
  ...
  it('should create', () => {
    ...
    expect(component instanceof MediumListPage).toBeTruthy();
  });
