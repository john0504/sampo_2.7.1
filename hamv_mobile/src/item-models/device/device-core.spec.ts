...
describe('device core test cases', () => {
  ...
  it('bind device, with a full content IM', () => {
    ...
    expect(deviceCore.controllers.length).toEqual(3);
    expect(deviceCore.chartComponents.length).toEqual(1);
    expect(deviceCore.primaryControllers.length).toEqual(1);
    expect(deviceCore.secondaryControllers.length).toEqual(2);
    expect(deviceCore.actions.length).toEqual(3);
    expect(deviceCore.primaryActions.length).toEqual(2);
    expect(deviceCore.secondaryActions.length).toEqual(1);
  });
  ...
  it('bind device, with a full content IM, bind again', () => {
    ...
    expect(deviceCore2.controllers.length).toEqual(3);
    expect(deviceCore2.chartComponents.length).toEqual(1);
    expect(deviceCore2.primaryControllers.length).toEqual(1);
    expect(deviceCore2.secondaryControllers.length).toEqual(2);
    expect(deviceCore2.actions.length).toEqual(3);
    expect(deviceCore2.primaryActions.length).toEqual(2);
    expect(deviceCore2.secondaryActions.length).toEqual(1);
  });
