...
import { WebViewMock } from '../mocks/providers.mocks';
...
describe('Check theme service', () => {
  ...
  it('test all files are empty case', () => {
    ...
    return instance.setup(renderer)
      ...
      .then(() => {
        expect(instance.config).toEqual(jasmine.any(Object));
        expect(instance.logoUrl).toEqual('assets/img/logo.png');
        expect(instance.navbarLogoUrl).toEqual('assets/img/logo_navbar.png');
